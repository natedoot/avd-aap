...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF3 | Vlan4094 | 1.1.1.73 | Port-Channel3 |
...
| --------- | ----------- | ------------- | ---------- | --- | --- | -------- | ------ | ------- |
| Ethernet1 | P2P_dc1-spine1_Ethernet5 | - | 1.1.255.17/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_dc1-spine2_Ethernet5 | - | 1.1.255.19/31 | default | 1500 | False | - | - |
...
| 1.1.1.105 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 1.1.1.105 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF11 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65103
   ...
   neighbor 1.1.1.105 description dc1-leaf3b_Vlan4093
   neighbor 1.1.255.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 1.1.255.16 remote-as 65100
   neighbor 1.1.255.16 description dc1-spine1_Ethernet5
   neighbor 1.1.255.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 1.1.255.18 remote-as 65100
   neighbor 1.1.255.18 description dc1-spine2_Ethernet5
   ...
   vrf VRF11
      ...
      update wait-install
      neighbor 1.1.1.105 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 1.1.1.105 description dc1-leaf3b_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
