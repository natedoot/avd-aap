...
| dc1-leaf1a | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:34 dc1-leaf1a ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1451) -- Master ProcMgr (PID=1451) exiting.<br> May 12 17:57:51 dc1-leaf1a Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.2 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:51 dc1-leaf1a Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.0 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> <br> |
...
| dc1-leaf1b | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:48 dc1-leaf1b ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1450) -- Master ProcMgr (PID=1450) exiting.<br> May 12 17:57:52 dc1-leaf1b Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.6 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:52 dc1-leaf1b Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.4 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> <br> |
...
| dc1-leaf2a | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:48 dc1-leaf2a ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1450) -- Master ProcMgr (PID=1450) exiting.<br> May 12 17:56:48 dc1-leaf2a StpTxRx: %FWK-3-SOCKET_CLOSE_REMOTE: Connection to Stp (pid:1926) at tbl://stpListen/+n closed by peer (EOF)<br> May 12 17:56:48 dc1-leaf2a StpTxRx: %FWK-3-MOUNT_PEER_CLOSED: Peer closed socket connection. (tbl://stpListen/+n-in)(Stp (pid:1926))<br> May 12 17:57:54 dc1-leaf2a Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.10 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:54 dc1-leaf2a Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.8 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> <br> |
...
| dc1-leaf2b | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:43 dc1-leaf2b ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1452) -- Master ProcMgr (PID=1452) exiting.<br> May 12 17:56:44 dc1-leaf2b Stp: %FWK-3-SOCKET_CLOSE_REMOTE: Connection to StpTxRx (pid:1894) at tbl://stpTxRxListen/+n closed by peer (EOF)<br> May 12 17:56:44 dc1-leaf2b Stp: %FWK-3-MOUNT_PEER_CLOSED: Peer closed socket connection. (tbl://stpTxRxListen/+n-in)(StpTxRx (pid:1894))<br> May 12 17:57:51 dc1-leaf2b Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.14 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:51 dc1-leaf2b Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.12 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> <br> |
...
| dc1-leaf3a | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:43 dc1-leaf3a ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1451) -- Master ProcMgr (PID=1451) exiting.<br> May 12 17:56:43 dc1-leaf3a StpTxRx: %FWK-3-SOCKET_CLOSE_REMOTE: Connection to Stp (pid:1935) at tbl://stpListen/+n closed by peer (EOF)<br> May 12 17:56:43 dc1-leaf3a StpTxRx: %FWK-3-MOUNT_PEER_CLOSED: Peer closed socket connection. (tbl://stpListen/+n-in)(Stp (pid:1935))<br> <br> |
...
| dc1-leaf3b | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:40 dc1-leaf3b ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1452) -- Master ProcMgr (PID=1452) exiting.<br> May 12 17:56:40 dc1-leaf3b StpTxRx: %FWK-3-SOCKET_CLOSE_REMOTE: Connection to Stp (pid:1932) at tbl://stpListen/+n closed by peer (EOF)<br> May 12 17:56:40 dc1-leaf3b StpTxRx: %FWK-3-MOUNT_PEER_CLOSED: Peer closed socket connection. (tbl://stpListen/+n-in)(Stp (pid:1932))<br> May 12 17:57:42 dc1-leaf3b Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.22 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:42 dc1-leaf3b Bgp: %BGP-3-NOTIFICATION: sent to neighbor 1.1.255.20 (VRF default AS 65100) 6/5 (Cease/connection rejected) 0 bytes<br> <br> |
...
| dc1-spine1 | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:30 dc1-spine1 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1410) -- Master ProcMgr (PID=1410) exiting.<br> May 12 17:56:30 dc1-spine1 Stp: %FWK-3-SOCKET_CLOSE_REMOTE: Connection to StpTxRx (pid:1836) at tbl://stpTxRxListen/+n closed by peer (EOF)<br> May 12 17:56:30 dc1-spine1 Stp: %FWK-3-MOUNT_PEER_CLOSED: Peer closed socket connection. (tbl://stpTxRxListen/+n-in)(StpTxRx (pid:1836))<br> May 12 17:57:43 dc1-spine1 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.21 (VRF default AS 65103) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:51 dc1-spine1 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.13 (VRF default AS 65102) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:52 dc1-spine1 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.1 (VRF default AS 65101) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:52 dc1-spine1 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.5 (VRF default AS 65101) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:54 dc1-spine1 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.9 (VRF default AS 65102) 6/5 (Cease/connection rejected) 0 bytes<br> <br> |
...
| dc1-spine2 | Logging | VerifyLoggingErrors | Verifies there are no syslog messages with a severity of ERRORS or higher. | ❌&nbsp;Failure | Device has reported syslog messages with a severity of ERRORS or higher:<br>May 12 17:56:23 dc1-spine2 ProcMgr: %PROCMGR-3-SHUTDOWNREQUESTED: ProcMgr shutdown requested via SIGQUIT or SIGTERM to worker (PID=1407) -- Master ProcMgr (PID=1407) exiting.<br> May 12 17:56:23 dc1-spine2 StpTxRx: %FWK-3-SOCKET_CLOSE_REMOTE: Connection to Stp (pid:1867) at tbl://stpListen/+n closed by peer (EOF)<br> May 12 17:57:43 dc1-spine2 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.23 (VRF default AS 65103) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:52 dc1-spine2 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.15 (VRF default AS 65102) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:52 dc1-spine2 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.3 (VRF default AS 65101) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:53 dc1-spine2 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.7 (VRF default AS 65101) 6/5 (Cease/connection rejected) 0 bytes<br> May 12 17:57:54 dc1-spine2 Bgp: %BGP-3-NOTIFICATION: received from neighbor 1.1.255.11 (VRF default AS 65102) 6/5 (Cease/connection rejected) 0 bytes<br> <br> |
